          ...
          {[
            ...
            const scheme =
              colorSchemes.category[
                category.key as keyof typeof colorSchemes.category
              ];
            return (
              <button
                key={category.key}
...
const JobCard: React.FC<{
  ...
  onApply: () => void;
  onShare: () => void;
}> = ({ job, index, onApply, onShare }) => {
  const [isHovered, setIsHovered] = useState(false);

  const genderColors =
    colorSchemes.gender[
      job.Gender.toLowerCase() as keyof typeof colorSchemes.gender
    ] || colorSchemes.gender.any;
          ...
          {[
            ...
            <div key={field.key}>
              ...
              <input
                type={field.type}
                required
                value={formData[field.key as keyof ApplyFormData] as string}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
